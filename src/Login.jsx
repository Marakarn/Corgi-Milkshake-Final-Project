            ...
            <section className="md:mx-24 md:mt-24 md:mb-24 flex flex-col md:flex-row">
              ...
              <article className="md:w-2/5 bg-[rgb(255,255,255)]/75 rounded-[20px]">
                  ...
                  <div className="flex flex-col p-[20px] relative">
                    ...
                    <button className="btn border-[2px] bg-[rgb(255,255,255)]/0 hover:bg-[rgb(255,255,255)]/80 drop-shadow border-[#5d6d39] text-[#5d6d39] text-xl font-normal">Sign Up</button>
                  </div>
              </article>
            </section>
          </main>
