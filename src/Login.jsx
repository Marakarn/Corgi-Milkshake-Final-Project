          ...
          <main className="container mx-auto font-poppins">
            <section className="md:mx-24 md:pt-24 md:mb-24 flex flex-col md:flex-row ">
              <article className="mt-5 md:mt-0 md:w-3/5">
                ...
                <h1 className="text-white text-5xl text-center md:text-start lg:text-7xl xl:text-8xl font-semibold mt-10 md:mt-[72px] drop-shadow">GreenSculpt</h1>
              </article>
              <article className="md:w-2/5 bg-[rgb(255,255,255)]/75 rounded-[20px]">
                  ...
                  <div className="flex flex-col p-[20px] relative">
                    <div className="flex flex-col">
                        <span class="material-symbols-outlined absolute inset-y-[45px] left-5 text-[#5d6d39]" id="account_circle">account_circle</span>
                      <input
                    ...
                    <i className="material-symbols-outlined absolute inset-y-[105px] left-5 text-[#5d6d39]" id="lock">lock</i>
                    <input
                    ...
                    />
                    <button className="btn bg-[#d2fe71] hover:bg-[#a5cf4a]/80 drop-shadow text-xl font-normal border-none h-[50px] mb-[40px]">Login</button>
                    <img className="w-40 mx-auto mb-[20px]" src="./LoginWarmUp.png"/>
                    <p className="text-center text-lg mb-[10px]">Don&apos;t have an account?</p>
                    <Link to="/signup">
                    <button className="btn border-[2px] bg-[rgb(255,255,255)]/0 hover:bg-[rgb(255,255,255)]/80 drop-shadow border-[#5d6d39] text-[#5d6d39] text-xl font-normal w-full">Sign Up</button>
                    </Link>
                  </div>
              </article>
            </section>
